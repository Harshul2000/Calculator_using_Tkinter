...
#get the user input and place it in textfield,eval() evaluates entire expression
i=0
...
#columspan below means how many columns it spans and sticky means it will go from west to east
display = Entry(root)
